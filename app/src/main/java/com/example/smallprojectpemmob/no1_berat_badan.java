...
public class no1_berat_badan extends AppCompatActivity {
    EditText edtNama, edtBB, edtTB;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_no1_berat_badan);
        setContentView(R.layout.activity_no1_berat_badan);
    ...
    public void cekHasil(View view) {
        ...
        if(edtNama.getText().toString().equals("")||edtBB.getText().toString().equals("")||edtTB.getText().toString().equals("")){
            ...
            Intent intent = new Intent(no1_berat_badan.this,no1_hasil.class);
